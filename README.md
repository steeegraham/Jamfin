...
```css
@import url("https://https://github.com/steeegraham/Jamfin/blob/main/theme/complete.css");
```
...
```css
@import url("https://https://github.com/steeegraham/Jamfin/blob/main/theme/base.css");
```
